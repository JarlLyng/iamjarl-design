// IAMJARL Design Tokens v1.12.1 — generated, do not edit
...
export declare const typography: {"family":{"ui":"system-ui","mono":"ui-monospace"},"weights":{"regular":400,"semibold":600,"bold":700},"sizes":{"xs":12,"sm":14,"base":16,"lg":18,"xl":24,"xxl":36},"lineHeights":{"xs":16,"sm":20,"base":24,"lg":28,"xl":32,"xxl":44}};
...
export declare const opacity: {"disabled":0.4,"muted":0.65};
